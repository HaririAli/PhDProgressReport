...
Therefore, one of our objectives is to support user-defined \gls{ucon} phases such that \acrshort{uscp} can be configured depending on the use-case.
...
Our architectural objectives are concerned with different deployments and applications of \gls{uscp} according to different use-cases.