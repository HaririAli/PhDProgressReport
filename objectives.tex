...
Moreover, we plan to define multiple state models that fit different use-cases, and to allow \acrshort{ucsp} to dynamically select the suitable state model based on the configuration or on the application.
