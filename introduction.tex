...
%Similarly,
Access control models have evolved over the years from \gls{mac} and \gls{dac} \cite{sandhu1993lattice} to the most prominent models, namely \gls{rbac} \cite{rbac1992nist} and \gls{abac} \cite{abac}.
...
Although \gls{ucon} extended access control with session-based evaluation and monitoring, and despite the significant works that extended and developed the model, some limitations still need to be addressed to accommodate some emerging use-cases.
In this report, we outline the state of the art of \gls{ucon}, then we discuss the related research problems and objectives as well as the research progress and plan.

The rest of the report is organised as follows:
Section \ref{sec:background} outlines the state of the art.
The research problems and objectives are described in Section \ref{sec:objectives}.
